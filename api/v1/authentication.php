...
$app->post('/login', function() use ($app) {
    ...
    $user = $db->getOneRecord("SELECT uid,name,password,email,herdnumber,created FROM customers_auth WHERE phone='$email' or email='$email'");
    if ($user != NULL) {
        ...
        $response['herdnumber'] = $user['herdnumber'];
        ...
        $_SESSION['herdnumber'] = $user['herdnumber'];
        } else {
